...
Los wheels conservan sus licencias completas dentro de sus directorios `.dist-info`: MIT para dry4python, crap4py y mutate4py; Apache-2.0 para coverage.py.
...
| coverage.py | 7.13.4, https://pypi.org/project/coverage/7.13.4/ | 1af1641e57cf7ba1bd67d677c9abdbcd6cc2ab7da3bca7fa1e2b7e50e65f2ad0 |
