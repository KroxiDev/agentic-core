...
Read `.agentic-core/golden-rules.md` from its canonical source. Code and tests are read-only; write only documentation when `brief.permissions` authorizes `documentation`.
